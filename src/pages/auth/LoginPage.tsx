...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // El redirect se maneja automáticamente en el useEffect
    } catch (error: any) {
  ...
  const features = [
    {
      ...
      description: "Accede a programas educativos en tecnología, desarrollo web, IA y marketing digital.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Obtén certificados reconocidos internacionalmente que validan tus habilidades tech.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Input
                ...
                rightIcon={
                  ...
                  >
                    {showPassword ? (
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L8.464 8.464M14.121 14.121l1.414 1.414M14.121 14.121L18 18" />
                      </svg>
                    ) : (
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Button
                ...
                className="mt-8"
              >
                {isLoading ? "Verificando acceso..." : "Acceder a mis Cursos"}
              </Button>
            </form>
            ...
            {isLoading && (
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-2xl">
                  <div className="flex items-center space-x-3">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-acent-600"></div>
