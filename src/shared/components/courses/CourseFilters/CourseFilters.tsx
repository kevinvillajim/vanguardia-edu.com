...
import { CourseFilters as Filters } from '../../../../services/courses/courseService';
import { AccessibleButton } from '../../ui/AccessibleButton/AccessibleButton';
            ...
            <fieldset>
              ...
              <div className={`flex flex-wrap gap-2 ${isMobile ? 'grid grid-cols-2' : ''}`}>
                <AccessibleButton
                  ...
                  ariaLabel="Filtrar por cursos gratuitos"
                >
                  Cursos gratuitos
                </AccessibleButton>
                ...
                <AccessibleButton
                  ...
                  ariaLabel="Filtrar por cursos de pago"
                >
                  Cursos de pago
                </AccessibleButton>
                ...
                <AccessibleButton
                  ...
                  ariaLabel="Ordenar por mejor valorados"
                >
                  Mejor valorados
                </AccessibleButton>
                ...
                <AccessibleButton
                  ...
                  ariaLabel="Ordenar por más populares"
                >
                  Más populares
                </AccessibleButton>
              </div>
