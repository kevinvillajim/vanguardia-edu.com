	...
	theme: {
		extend: {
			...
			backgroundImage: {
				...
				"gradient-primary": "linear-gradient(135deg, #95c11f 0%, #006938 100%)",
				"gradient-secondary":
					"linear-gradient(135deg, #9fc8b5 0%, #95c11f 100%)",
				"gradient-success": "linear-gradient(135deg, #95c11f 0%, #006938 100%)",
				"gradient-warning": "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)",
				"gradient-error": "linear-gradient(135deg, #ef4444 0%, #dc2626 100%)",
				"gradient-dark": "linear-gradient(135deg, #006938 0%, #004426 100%)",
				"gradient-light": "linear-gradient(135deg, #fefffe 0%, #e7f1e3 100%)",
			},
		...
		function ({addUtilities, addComponents, theme}) {
			addUtilities({
				".glass": {
					...
					border: "1px solid rgba(159, 200, 181, 0.2)",
				},
				".glass-dark": {
					"backdrop-filter": "blur(16px)",
					background: "rgba(0, 105, 56, 0.8)",
					border: "1px solid rgba(149, 193, 31, 0.2)",
				},
				".gradient-text": {
					background: "linear-gradient(135deg, #95c11f 0%, #006938 100%)",
